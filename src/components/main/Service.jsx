const Service = ({ service }) => {
  ...
  return (
    <div className="border-[3px] border-purple-600 rounded-md px-3 py-5 pb-7 space-y-3 hover:bg-gradient-to-r from-orange-900 to-purple-900 cursor-pointer hover:border-white hover:scale-110 transition-5">
      <h2 className="text-lg md:text-xl font-semibold">{s_no}</h2>
      <h3 className="text-xl md:text-2xl font-bold text-gradient">{s_name}</h3>
      <p className="text-lg font-medium">{s_desc}</p>
